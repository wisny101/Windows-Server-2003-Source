<%@ Page language="c#" Codebehind="home.aspx.cs" AutoEventWireup="false" Inherits="XReports.home" %>
...
<html>
	...
	<body id="bdMain" style="LEFT: 0px; POSITION: absolute; TOP: 0px" bottomMargin="0" leftMargin="0" topMargin="0"rightMargin="0" MS_POSITIONING="GridLayout">
		<form id="home" method="post" runat="server">
			...
			<DIV class="DNormal" style="Z-INDEX: 101; LEFT: 208px; WIDTH: 707px; POSITION: absolute; TOP: 167px; HEIGHT: 73px" ms_positioning="FlowLayout"> 
				Select from the side menu of the actions you wish to perform</DIV>
