...
Zapraszamy do Instalatora systemu Windows
  ...
  Naciònij klawisz ENTER, aby kontynuowaÜ

     Naciònij klawisz F3, aby zako‰czyÜ
.
...
Language=English
Instalacja nie powiod≥a siÍ.
Naciúnij dowolny klawisz, aby ponownie uruchomiÊ komputer.
.
...
Language=English
Dyskietka obs≥ugi sprzÍtu dostarczona przez producenta
.

MessageID=9009 SymbolicName=SL_MSG_INSERT_DISK
Language=English
W≥Ûø dyskietkÍ oznaczonπ



               do stacji dyskÛw A:

 *  Naciúnij klawisz ENTER, gdy gotowe.
.

MessageID=9010 SymbolicName=SL_MSG_EXIT_DIALOG
Language=English
µêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêÅ
Ä System Windows nie jest ca≥kowicie zainstalowany.            Ä
Ä Jeúli zakoÒczysz instalacjÍ teraz, trzeba bÍdzie ponownie    Ä
Ä uruchomiÊ Instalatora, aby zainstalowaÊ system Windows.      Ä
Ä                                                              Ä
Ä     * Naciúnij klawisz ENTER, aby kontynuowaÊ instalacjÍ.    Ä
Ä     * Naciúnij klawisz F3, aby zakoÒczyÊ.                    Ä
„©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©©¬
Ä  F3=ZakoÒcz  ENTER=Kontynuuj                                 Ä
ÆêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêêÉ
.
...
Language=English
Naciònij dowolny klawisz, aby ponownie uruchomiÜ komputer.
.

MessageID=9025 SymbolicName=SL_WARNING_ERROR
Language=English
Wystπpi≥ niespodziewany b≥πd (%d) 
w wierszu %d w %s.
...
system szuka≥ stacji dyskÛw %d.
.

MessageID=9027 SymbolicName=SL_NO_MEMORY
Language=English
Zabrak≥o pamiÍci dla systemu
w wierszu %d pliku %s
.

MessageID=9028 SymbolicName=SL_IO_ERROR
Language=English
System napotka≥ b≥πd We/Wy
podczas uzyskiwania dostÍpu do %s.
.
...
Language=English
Instalator nie moæe kontynuowaÜ. Naciònij dowolny klawisz, aby zako‰czyÜ.
.

MessageID=9036 SymbolicName=SL_PROMPT_SCSI
Language=English
Wybierz kartÍ SCSI z poniøszej listy lub wybierz opcjÍ "Inny", jeúli 
...
za pomocπ dysku ze sterownikami obs≥ugi dostarczonymi przez producenta karty.

Wybierz odpowiedniπ kartÍ SCSI z poniøszej listy lub naciúnij klawisz ESC,
aby powrÛciÊ do poprzedniego ekranu.

.
MessageID=9038 SymbolicName=SL_PROMPT_HAL
Language=English
Instalator nie mÛg≥ okreúliÊ typu komputera lub wybrano samodzielne
okreúlenie typu komputera.

Wybierz typ komputera z poniøszej listy lub wybierz opcjÍ "Inny", jeúli 
masz dysk ze sterownikami obs≥ugi dostarczonymi przez producenta komputera.

Aby przewinπÊ elementy menu, naciúnij klawisz strza≥ki w dÛ≥ lub
strza≥ki w gÛrÍ.
...
za pomocπ dysku ze sterownikami obs≥ugi dostarczonymi przez producenta
komputera.

Wybierz odpowiedni typ komputera z poniøszej listy lub naciúnij 
klawisz ESC, aby powrÛciÊ do poprzedniego ekranu.
...
Language=English
Instalator nie mÛg≥ okreúliÊ typu karty wideo zainstalowanej w tym systemie.

Wybierz typ karty wideo z poniøszej listy lub wybierz opcjÍ "Inny", jeúli 
masz dysk ze sterownikami obs≥ugi dostarczonymi przez producenta karty.
...
Wybierz odpowiedniπ kartÍ wideo z poniøszej listy lub naciúnij 
klawisz ESC, aby powrÛciÊ do poprzedniego ekranu.
...
Language=English
Plik %s wywo≥a≥ niespodziewany b≥πd (%d)
w wierszu %d w %s.
...
Language=English
SETUPLDR: nie moæna otworzyÜ dysku %s
.
...
Jeúli w stacji A: znajduje siÍ dyskietka, usuÒ jπ.

Naciúnij klawisz ENTER, aby ponownie uruchomiÊ komputer.
.
...
Language=English
Instalator nie moæe znale´Ü sterownik¢w wybranego urz•dzenia.
...
Language=English
Dostarczony dysk nie zawiera odpowiednich plikÛw obs≥ugi.
...
Language=English
Nie moæna odczytaÜ dysku, poniewaæ zawiera on nierozpoznany system plik¢w.
...
Language=English
Naciònij klawisz F6, aby zainstalowaÜ sterownik SCSI lub RAID innej firmy...
.
...
Language=English
S=Okreòl dodatkowe urz•dzenie   ENTER=Kontynuuj   F3=Zako‰cz
.

MessageID=9062 SymbolicName=SL_SCSI_SELECT_MESSAGE_2
Language=English
  * Naciúnij klawisz S, aby okreúliÊ dodatkowe karty SCSI, dyski CD-ROM lub
    specjalne kontrolery dyskÛw, ktÛre majπ byÊ obs≥ugiwane przez system
    Windows, w tym rÛwnieø te, do ktÛrych masz sterowniki od producenta
    masowego urzπdzenia magazynujπcego.

  * Naciúnij klawisz ENTER, jeúli nie masz sterownikÛw dostarczonych przez
    producenta masowego urzπdzenia magazynujπcego lub jeúli nie chcesz 
    okreúlaÊ dodatkowych masowych urzπdzeÒ magazynujπcych do obs≥ugi przez 
    system Windows.
.

MessageID=9063 SymbolicName=SL_SCSI_SELECT_MESSAGE_1
Language=English
Instalator nie mÛg≥ okreúliÊ typu co najmniej jednego masowego urzπdzenia 
magazynujπcego lub wybrano samodzielne okreúlenie typu karty. Instalator 
za≥aduje teraz obs≥ugÍ nastÍpujπcych masowych urzπdzeÒ magazynujπcych:
.

MessageID=9064 SymbolicName=SL_SCSI_SELECT_MESSAGE_3
Language=English
Instalator za≥aduje obs≥ugÍ nastÍpujπcych masowych urzπdzeÒ magazynujπcych:
.

MessageID=9065 SymbolicName=SL_SCSI_SELECT_ERROR
Language=English
Instalator nie mÛg≥ za≥adowaÊ obs≥ugi okreúlonego masowego urzπdzenia 
magazynujπcego. Instalator za≥aduje teraz obs≥ugÍ nastÍpujπcych masowych 
urzπdzeÒ magazynujπcych:
.
...
Language=English
Nie moøna uruchomiÊ systemu Windows z powodu nastÍpujπcego problemu
z konfiguracjπ rozruchowπ oprogramowania uk≥adowego ARC:
.
...
Language=English
Sprawdü w dokumentacji systemu Windows oraz
w instrukcji obs≥ugi sprzÍtu dodatkowe informacje
...
Language=English
Zainstalowana w komputerze karta sieciowa z moæliwoòci• rozruchu
posiada starsz• wersj© oprogramowania ROM i nie moæna jej uæyÜ
do instalacji zdalnej systemu Windows. 
Skontaktuj si© z administratorem systemu lub producentem komputera,
aby uzyskaÜ informacje na temat uaktualnienia oprogramowania ROM.
.
MessageID=9083 SymbolicName=SL_NETBOOT_SERVER_ERROR
Language=English
Wybrany obraz systemu operacyjnego nie zawiera wymaganych sterownik¢w
dla karty sieciowej. Spr¢buj wybraÜ inny obraz systemu operacyjnego.
...
Language=English
Us≥uga zabezpieczeÒ jπdra
.
MessageID=9089 SymbolicName=SL_WRONG_PROM_VERSION
Language=English
Oprogramowanie uk≥adowe (PROM) znajdujπce siÍ w tym systemie nie ma
wymaganego numeru wersji. Skontaktuj siÍ z pomocπ technicznπ SGI lub
odwiedü witrynÍ sieci Web firmy SGI w celu otrzymania aktualizacji
oprogramowania PROM oraz instrukcji dotyczπcych uaktualnienia.

Uwaga: moøesz uruchomiÊ poprzednie instalacje systemu Microsoft(R) 
Windows(R), wybierajπc odpowiedni wpis rozruchowy menu startowego zamiast 
aktualnie ustawionej opcji domyúlnej "Instalator systemu Windows".
.
MessageID=9090 SymbolicName=SIGNATURE_CHANGED
Language=English
Instalator wykry≥ w tym komputerze kilka dyskÛw, ktÛre sπ nierozrÛønialne 
...
System Windows zawiera juæ sterownik, kt¢rego moæna uæyÜ dla
"%s".

O ile producent urz•dzenia nie zaleca uæywania sterownika zamieszczonego  
na dyskietce, naleæy uæyÜ sterownika zawartego w systemie Windows.
.

MessageID=9093 SymbolicName=SL_CONFIRM_OEMDRIVER
Language=English
S=Uæyj sterownika z dyskietki ENTER=Uæyj domyòlnego sterownika systemu Windows
.

MessageID=9094 SymbolicName=SL_OEMDRIVER_NEW
Language=English
Wydaje si©, æe sterownik zapewniony przez uæytkownika jest nowszy 
niæ sterownik domyòlny zawarty w systemie Windows.
.

MessageID=9095 SymbolicName=SL_INBOXDRIVER_NEW
Language=English
Wydaje si©, æe sterownik zapewniony przez uæytkownika jest starszy 
niæ sterownik domyòlny zawarty w systemie Windows.
.
...
Language=English
Naciònij klawisz F2, aby uruchomiÜ automatyczne odzyskiwanie systemu (ASR)...
.

MessageID=9099 SymbolicName=SL_MSG_WARNING_ASR
Language=English
          W≥Ûø dysk oznaczony etykietπ:
...
Dysk automatycznego odzyskiwania systemu Windows
      ...
      Naciúnij dowolny klawisz, gdy gotowe.
.


MessageID=9100 SymbolicName=SL_TEXT_REQUIRED_FEATURES_MISSING
Language=English
System Windows wymaga pewnych funkcji procesora, ktÛrych nie zapewnia
procesor tego komputera. System Windows wymaga zw≥aszcza nastÍpujπcych
instrukcji:
...
aby anulowaÜ, naciònij klawisz ESC...
.
...
Language=English
Trwa uruchamianie òrodowiska preinstalacji systemu Windows...
.
...
Language=English
Instalator nie moøe znaleüÊ w tym komputerze stacji dyskÛw,
aby za≥adowaÊ z dyskietki sterowniki OEM.

    * Naciúnij klawisz ESC, aby anulowaÊ ≥adowanie sterownikÛw OEM.

    * Naciúnij klawisz F3, aby zakoÒczyÊ instalacjÍ.
.

MessageID=9110 SymbolicName=SL_UPGRADE_IN_PROGRESS
Language=English
Ten komputer jest juæ uaktualniany do systemu Microsoft Windows.
Co chcesz zrobiÜ?

    * Aby kontynuowaÜ bieæ•ce uaktualnienie, naciònij klawisz ENTER.

    * Aby anulowaÜ bieæ•ce uaktualnienie i zainstalowaÜ now• wersj©
      systemu Microsoft Windows, naciònij klawisz F10.

    * Aby zako‰czyÜ instalacj© bez instalowania systemu
      Microsoft Windows, naciònij klawisz F3.
.
...
Language=English
Instalator nie moøe za≥adowaÊ sterownikÛw OEM.
...
Language=English
System Windows nie moøe zostaÊ uruchomiony z powodu b≥Ídu podczas rozruchu
z dysku RAMDISK.
.

MessageID=15001 SymbolicName=BL_RAMDISK_INVALID_OPTIONS
Language=English
Opcje dysku RAMDISK okreúlone w pliku boot.ini sπ nieprawid≥owe.
.

MessageID=15002 SymbolicName=BL_RAMDISK_BUILD_FAILURE
Language=English
System Windows nie moæe zbudowaÜ obrazu rozruchowego dysku RAMDISK.
.

MessageID=15003 SymbolicName=BL_RAMDISK_BOOT_FAILURE
Language=English
System Windows nie moæe otworzyÜ obrazu RAMDISK.
.
