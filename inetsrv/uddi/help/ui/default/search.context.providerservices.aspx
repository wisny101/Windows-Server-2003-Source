		...
		<table class="content" width="100%" cellpadding="8">
			<tr>
				<td>
					...
					Use the <B>Services</B> tab to view the services that are published by this provider.
					<ul>
					<li>
						<b>Services:</b> Displays the services that are published by this provider. Click any service to view more information about it.
					</ul>										
					<p>
