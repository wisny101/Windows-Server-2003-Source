		...
		<table class="content" width="100%" cellpadding="8">
			<tr>
				<td>
					...
					Use the <b>Details</b> tab to view the access point and descriptions of 
					this binding.
					<UL>
						<li>
							<b>Access Point:</b> Displays the Uniform Resource Locator (URL) where this binding can be accessed and the 
							protocol it supports.
						</li>
						<li>
							<b>Description:</b> Contains descriptions of this binding and the language for 
