		...
		<table class="content" width="100%" cellpadding="8">
			<tr>
				<td>
					...
					Use the <B>Instance Info</B> tab to view the instance infos that are associated with a service.
					<ul>
					<li>
						<b>Instance Infos:</b> Lists the instance infos associated with this binding.
					</ul>										
					<p>
